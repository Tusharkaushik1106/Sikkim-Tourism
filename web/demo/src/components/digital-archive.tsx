...
import { FiCamera, FiBook, FiVideo, FiMusic, FiTag, FiMapPin, FiCompass, FiStar, FiHome, FiUsers, FiAward, FiBriefcase } from 'react-icons/fi';
...
const archiveData: ArchiveItem[] = [
  {
    ...
    description:
      "A mesmerizing performance of the traditional Lepcha dance during Tendong Lho Rum Faat festival, showcasing the rich cultural heritage that attracts cultural tourists to Sikkim.",
    category: "photograph",
    year: 1985,
  ...
  },
  {
    ...
    description:
      "Rare Buddhist manuscripts and artifacts from Rumtek Monastery, one of Sikkim's most visited spiritual tourism destinations, attracting thousands of pilgrims yearly.",
    category: "document",
    year: 1578,
  ...
  },
  {
    ...
    description:
      "A breathtaking timelapse video capturing the golden sunrise over Mount Kanchenjunga from Tiger Hill, one of Sikkim's most popular tourism attractions.",
    category: "video",
    year: 2019,
  ...
  },
  {
    ...
    description:
      "Traditional folk songs from Lachung and Lachen villages, preserved as part of cultural tourism initiatives showcasing authentic mountain community traditions.",
    category: "audio",
    year: 1992,
  ...
  },
  {
    ...
    description:
      "Exquisite handwoven Lepcha textiles showcased in tourism craft centers, featuring traditional patterns that make popular souvenirs for visitors.",
    category: "artifact",
    year: 1920,
  ...
  },
  {
    ...
    description:
      "Original documents from the Treaty of Titalia (1817), displayed in heritage tourism sites showcasing Sikkim's colonial history and political evolution.",
    category: "document",
    year: 1817,
  ...
  },
  {
    ...
    description:
      "Sacred Cham dance at Pemayangtse Monastery, a major religious tourism attraction featuring elaborate masks and drawing international visitors.",
    category: "video",
    year: 2018,
    location: "Pemayangtse Monastery, West Sikkim",
    thumbnail:
      "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=400&h=300&fit=crop&crop=center",
    tags: [
      "cham-dance",
      "monastery",
      "masks",
  ...
  },
  {
    ...
    description:
      "Former Royal Palace of Sikkim, now a major heritage tourism attraction in Gangtok showcasing traditional Sikkimese royal architecture.",
    category: "photograph",
    year: 1975,
    location: "Gangtok Royal Palace Complex, East Sikkim",
    thumbnail:
      "https://upload.wikimedia.org/wikipedia/commons/d/d8/Tsuklakhang.jpg",
    tags: [
      "architecture",
      "palace",
      "royal",
  ...
  },
  {
    ...
    description:
      "Valley of Flowers in North Sikkim, featuring rare Himalayan flora and serving as a premier nature tourism destination for eco-tourists.",
    category: "photograph",
    year: 2020,
  ...
  },
  {
    ...
    description:
      "Ancient Tibetan prayer wheels along Gangtok's spiritual tourism circuit, popular with pilgrims and cultural tourists seeking authentic experiences.",
    category: "artifact",
    year: 1650,
    location: "Enchey Monastery & Spiritual Circuit, Gangtok",
    thumbnail:
      "https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=400&h=300&fit=crop&crop=center",
    tags: [
      "tibetan",
      "prayer-wheels",
      "monastery",
  ...
  },
  {
    ...
    description:
      "Authentic Sikkimese wedding ceremony in Pelling, now offered as cultural tourism experiences for visitors wanting traditional celebrations.",
    category: "video",
    year: 2017,
  ...
  },
  {
    ...
    description:
      "Ancient stone inscriptions at Yuksom, Sikkim's first capital, now a UNESCO heritage tourism site attracting history enthusiasts.",
    category: "document",
    year: 1200,
    location: "Yuksom Historical Heritage Site, West Sikkim",
    thumbnail:
      "https://media.assettype.com/outlookindia/import/uploadimage/library/16_9/16_9_5/IMAGE_1651817268.webp?w=801&auto=format%2Ccompress&fit=max&format=webp&dpr=1.0",
    tags: [
      "stone",
      "inscriptions",
      "ancient",
  ...
  },
  {
    ...
    description:
      "Traditional Sikkimese music performed during trekking expeditions, enhancing the adventure tourism experience in North Sikkim mountains.",
    category: "audio",
    year: 1988,
  ...
  },
  {
    ...
    description:
      "Ancient wall paintings at Tashiding Monastery, a sacred pilgrimage tourism destination known for its spiritual significance and artistic heritage.",
    category: "photograph",
    year: 1716,
    location: "Tashiding Sacred Monastery, West Sikkim",
    thumbnail:
      "https://tripxl.com/blog/wp-content/uploads/2024/08/Sanga-Choeling-Monastery.jpg",
    tags: [
      "monastery",
      "paintings",
      "buddhist",
  ...
  },
  {
    ...
    description:
      "Traditional terraced farming in Ravangla, showcasing Sikkim's 100% organic farming practices as part of sustainable agro-tourism.",
    category: "video",
    year: 2021,
    location: "Ravangla Organic Farms, South Sikkim",
    thumbnail:
      "https://images.unsplash.com/photo-1464207687429-7505649dae38?w=400&h=300&fit=crop&crop=center",
    tags: [
      "farming",
      "agriculture",
      "terracing",
  ...
  },
  {
    ...
    description:
      "Ancient copper vessels displayed in monastery museums along the cultural tourism circuit, showcasing traditional Buddhist craftsmanship.",
    category: "artifact",
    year: 1780,
    location: "Monastery Museums Circuit, Sikkim",
    thumbnail:
      "https://www.wondersoftibet.com/wp-content/uploads/2020/02/Chapel-in-Shalu-Monastery-1024x731.jpg",
    tags: [
      "copper",
      "vessels",
      "ritual",
  ...
  },
  {
    ...
    description:
      "Annual Rhododendron Festival in Barsey, a major eco-tourism event celebrating Sikkim's state flower and attracting nature lovers globally.",
    category: "photograph",
    year: 2019,
  ...
  },
  {
    ...
    description:
      "Oral histories from Dzongu Lepcha Reserve, showcasing indigenous culture through community-based tourism initiatives.",
    category: "audio",
    year: 2020,
  ...
  },
  {
    ...
    description:
      "British colonial era photographs showing the development of hill station tourism in the Darjeeling-Sikkim region.",
    category: "photograph",
    year: 1890,
    location: "Colonial Hill Stations, Darjeeling-Sikkim",
    thumbnail:
      "https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/0a/b3/95/f0.jpg",
    tags: [
      "colonial",
      "historical",
      "british",
  ...
  },
  {
    ...
    description:
      "Ancient Buddhist texts at Dubdi Monastery, Sikkim's oldest monastery and important pilgrimage tourism destination.",
    category: "document",
    year: 1456,
  ...
  },
  {
    ...
    description:
      "Comprehensive documentary showcasing Sikkimese architecture featured in heritage tourism trails across the state.",
    category: "video",
    year: 2022,
    location: "Heritage Architecture Trail, Statewide Sikkim",
    thumbnail:
      "https://www.artchitectours.com/wp-content/uploads/2018/11/shanghai-tradition-modernity-02-1.jpg",
    tags: [
      "architecture",
      "documentary",
      "traditional",
  ...
  },
  {
    ...
    description:
      "Handcrafted Sikkimese jewelry popular among tourists, featuring silver, coral, and turquoise in traditional designs.",
    category: "artifact",
    year: 1850,
  ...
  },
  {
    ...
    description:
      "Sacred Buddhist chants recorded during dawn prayers, offering tourists authentic spiritual experiences across Sikkim's monasteries.",
    category: "audio",
    year: 2023,
    location: "Monastery Spiritual Tourism Circuit, Sikkim",
    thumbnail:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuGXxX5O2MxrnluwoZOL_qFQo8-LTTuByfCg&s",
    tags: [
      "chants",
      "buddhist",
      "prayers",
  ...
  },
  {
    ...
    description:
      "Ancient trade route maps now used for developing adventure tourism and trekking trails connecting Tibet, Sikkim, and Bhutan.",
    category: "document",
    year: 1835,
    location: "Trans-Himalayan Trade Routes",
    thumbnail:
      "https://upload.wikimedia.org/wikipedia/commons/c/c1/1881_Map_of_Sikkim_by_Sir_Richard_Temple.jpg",
    tags: [
      "maps",
      "historical",
      "trade-routes",
  ...
  },
  {
    ...
    description:
      "Sacred rituals at Tsomgo Lake, a high-altitude glacial lake and major tourism destination offering spiritual and adventure experiences.",
    category: "video",
    year: 2021,
    location: "Tsomgo (Changu) Lake, East Sikkim",
    thumbnail:
      "https://images.unsplash.com/photo-1605540436563-5bca919ae766?w=400&h=300&fit=crop&crop=center",
    tags: [
      "tsomgo",
      "changu-lake",
      "sacred",
  ...
  },
  {
    ...
    description:
      "Vibrant pedestrian mall in Gangtok featuring handicrafts and souvenirs, central to Sikkim's urban tourism experience.",
    category: "photograph",
    year: 2022,
  ...
  },
  {
    ...
    description:
      "Mountain rescue operations documentation highlighting safety measures for adventure tourism in Sikkim's high-altitude regions.",
    category: "document",
    year: 1995,
  ...
  },
  {
    ...
    description:
      "Traditional cooking methods showcased in culinary tourism experiences, featuring authentic momos, thukpa, and local delicacies.",
    category: "video",
    year: 2020,
  ...
  },
  {
    ...
    description:
      "Elaborate festival masks displayed in cultural tourism centers, representing various Buddhist deities and local folklore.",
    category: "artifact",
    year: 1700,
    location: "Cultural Tourism Museums, Sikkim",
    thumbnail:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgGFnDEo0DHgHke99VDNjA3j5L1veu3e7Lnw&s",
    tags: [
      "masks",
      "festivals",
      "ceremonies",
  ...
  },
  {
    ...
    description:
      "Authentic homestay experiences in Sikkimese villages, showcasing sustainable community-based tourism initiatives.",
    category: "photograph",
    year: 2023,
    location: "Community Homestays, All Districts Sikkim",
    thumbnail:
      "https://images.unsplash.com/photo-1600298881974-6be191ceeda1?w=400&h=300&fit=crop&crop=center",
    tags: [
      "homestay",
      "community-tourism",
      "village-life",
...
const categories = [
  {
    key: "all",
    label: "All Tourism Archives",
    icon: <FiHome className="w-6 h-6 inline-block text-orange-900 dark:text-orange-300" />,
    color: "bg-orange-500 dark:bg-orange-600",
  },
  {
    key: "photograph",
    label: "Tourism Photos",
    icon: <FiCamera className="w-6 h-6 inline-block text-green-900 dark:text-green-300" />,
    color: "bg-green-500 dark:bg-green-600",
  },
  {
    key: "document",
    label: "Tourism Documents",
    icon: <FiBook className="w-6 h-6 inline-block text-yellow-900 dark:text-yellow-300" />,
    color: "bg-yellow-500 dark:bg-yellow-600",
  },
  {
    key: "video",
    label: "Tourism Videos",
    icon: <FiVideo className="w-6 h-6 inline-block text-red-900 dark:text-red-300" />,
    color: "bg-red-500 dark:bg-red-600",
  },
  {
    key: "audio",
    label: "Tourism Audio",
    icon: <FiMusic className="w-6 h-6 inline-block text-purple-900 dark:text-purple-300" />,
    color: "bg-purple-500 dark:bg-purple-600",
  },
  {
    key: "artifact",
    label: "Tourism Artifacts",
    icon: <FiAward className="w-6 h-6 inline-block text-pink-900 dark:text-pink-300" />,
...
export default function DigitalArchive() {
    ...
    if (selectedYear !== "all") {
      ...
      filtered = filtered.filter((item) => {
        if (yearRange.length === 2) {
          return (
            item.year >= parseInt(yearRange[0]) &&
            item.year <= parseInt(yearRange[1])
          );
        }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-emerald-50 dark:from-slate-900 dark:via-emerald-900 dark:to-blue-900 transition-colors duration-500">
      ...
      <div
        ref={heroRef}
        className="mt-12 relative overflow-hidden bg-gradient-to-br from-blue-600 via-emerald-600 to-teal-600 dark:from-blue-800 dark:via-emerald-800 dark:to-teal-800 transition-colors duration-500"
      >
        <div className="absolute inset-0 bg-black/20 dark:bg-black/40"></div>

        {/* Tourism Pattern Overlay */}
        <div className="absolute inset-0 opacity-10">
          <FiCompass className="absolute top-16 left-20 text-6xl animate-bounce text-blue-900 dark:text-blue-300" />
          <FiMapPin className="absolute top-32 right-24 text-4xl animate-float text-emerald-900 dark:text-emerald-300" />
          <FiBriefcase className="absolute bottom-32 left-16 text-5xl animate-float delay-1000 text-orange-900 dark:text-orange-300" />
          <FiCamera className="absolute bottom-20 right-20 text-4xl animate-bounce delay-2000 text-pink-900 dark:text-pink-300" />
          <FiCompass className="absolute top-1/2 left-1/4 text-3xl animate-float delay-500 text-blue-900 dark:text-blue-300" />
          <FiAward className="absolute top-1/3 right-1/3 text-5xl animate-float delay-1500 text-yellow-900 dark:text-yellow-300" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center scroll-animate opacity-0 transform translate-y-8 transition-all duration-1000 ease-out">
            ...
            <div className="flex flex-row justify-center items-center gap-8 mb-10">
              <span className="flex items-center gap-2 text-2xl md:text-3xl text-blue-100 dark:text-blue-200 font-semibold">
                <FiCompass className="text-blue-900 dark:text-blue-300" />
                Discover
              </span>
              <span className="flex items-center gap-2 text-2xl md:text-3xl text-yellow-100 dark:text-yellow-200 font-semibold">
                <FiAward className="text-yellow-900 dark:text-yellow-300" />
                Culture
              </span>
              <span className="flex items-center gap-2 text-2xl md:text-3xl text-emerald-100 dark:text-emerald-200 font-semibold">
                <FiMapPin className="text-emerald-900 dark:text-emerald-300" />
                Adventure
              </span>
              <span className="flex items-center gap-2 text-2xl md:text-3xl text-orange-100 dark:text-orange-200 font-semibold">
                <FiHome className="text-orange-900 dark:text-orange-300" />
                Heritage
              </span>
            </div>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              >
                <span className="flex items-center">Start Exploring</span>
              </button>
              <button
                onClick={() => {
      ...
      <div
        ref={statsRef}
        className="py-20 bg-gradient-to-r from-emerald-100 via-cyan-100 to-blue-100 dark:from-emerald-900 dark:via-cyan-900 dark:to-blue-900 border-y border-blue-200/50 dark:border-emerald-700/50 transition-colors duration-500"
      >
            ...
            {[
              {
                ...
                icon: <FiBriefcase className="w-8 h-8 mx-auto text-emerald-900 dark:text-emerald-300 animate-spin-slow" />,
                color: "from-emerald-500 to-teal-500",
              },
              {
                number: "300+",
                label: "Years of Heritage",
                icon: <FiBook className="w-8 h-8 mx-auto text-blue-900 dark:text-blue-300 animate-spin-slow" />,
                color: "from-blue-500 to-cyan-500",
              },
              {
                number: "2,500+",
                label: "Digital Stories",
                icon: <FiTag className="w-8 h-8 mx-auto text-purple-900 dark:text-purple-300 animate-spin-slow" />,
                color: "from-purple-500 to-pink-500",
              },
              {
                number: "100%",
                label: "Adventure Access",
                icon: <FiCompass className="w-8 h-8 mx-auto text-orange-900 dark:text-orange-300 animate-spin-slow" />,
                color: "from-orange-500 to-red-500",
              }
            ].map((stat, index) => (
              <div
                key={index}
                className="text-center scroll-animate opacity-0 transform translate-y-4 transition-all duration-700 ease-out"
                style={{ transitionDelay: `${index * 100}ms` }}
              >
                <div
                  className={`inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r ${stat.color} shadow-lg mb-4`}
                >
                  {stat.icon}
                </div>
      ...
      >
          ...
          {filteredItems.map((item, index) => (
            ...
            >
              {viewMode === "grid" ? (
                // Tourism Grid Card
                <div
                  className="bg-gradient-to-br from-white/95 to-blue-50/95 dark:from-gray-800/95 dark:to-gray-700/95 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl border-2 border-blue-200/50 dark:border-gray-600/50 hover:shadow-3xl hover:scale-105 transition-all duration-500 cursor-pointer h-auto min-h-[500px]"
                  ...
                  <div className="p-8 flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {item.tags.slice(0, 4).map((tag) => (
                        <span
                          key={tag}
                          className="px-3 py-1.5 bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-gray-700 dark:to-gray-600 text-blue-700 dark:text-blue-300 text-sm rounded-full font-semibold border border-blue-200 dark:border-gray-600"
                        >
                          #{tag}
                        </span>
                      ))}
                ...
                // Tourism List Item
                <div
                  className="bg-gradient-to-r from-white/95 to-blue-50/95 dark:from-gray-800/95 dark:to-gray-700/95 backdrop-blur-sm rounded-3xl p-8 shadow-xl border-2 border-blue-200/50 dark:border-gray-600/50 hover:shadow-2xl transition-all duration-300 cursor-pointer"
                  onClick={() => setSelectedItem(item)}
                >
                  <div className="flex gap-8">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-4">
                        <h3 className="font-black text-2xl text-gray-900 dark:text-gray-100 line-clamp-2 leading-tight">
                          {item.title}
                        </h3>
                        <span className="text-base text-white bg-yellow-500 px-3 py-2 rounded-full font-bold ml-4">
                          {item.year}
                        </span>
                      </div>
                      <p className="text-gray-700 dark:text-gray-300 text-base mb-4 line-clamp-3 leading-relaxed">
                        {item.description}
                      </p>
                      <div className="flex flex-wrap gap-2 mb-4">
                        {item.tags.slice(0, 5).map((tag) => (
                          <span
                            key={tag}
                            className="px-3 py-1 bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-gray-700 dark:to-gray-600 text-blue-700 dark:text-blue-300 text-sm rounded-full font-semibold border border-blue-200 dark:border-gray-600"
                          >
                            #{tag}
                          </span>
                        ))}
        ...
        {filteredItems.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg">
              Try exploring different categories to discover amazing Sikkim
              experiences
            </p>
          </div>
        )}
            ...
            <div className="p-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedItem.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-2 py-1 bg-orange-100 dark:bg-gray-700 text-orange-800 dark:text-orange-300 text-xs rounded-full"
                      >
                        #{tag}
                      </span>
                    ))}
              ...
              <div className="flex gap-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                ...
                >
                  <Heart
                    className={`w-5 h-5 mr-2 ${
                      likedItems.has(selectedItem.id) ? "fill-current" : ""
                    }`}
                  />
